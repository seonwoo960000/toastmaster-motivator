...
import { memberPreparedSpeechProgress, lineChartOptionsTotalSpent } from 'variables/charts';
		...
		<Card justifyContent='center' alignItems='center' flexDirection='column' w='100%' mb='0px' {...rest}>
			...
			<Flex w='100%' flexDirection={{ base: 'column', lg: 'row' }}>
				...
				<Box minH='260px' minW='75%' mt='auto'>
					<LineChart chartData={memberPreparedSpeechProgress} chartOptions={lineChartOptionsTotalSpent} />
				</Box>
			</Flex>
		</Card>
	);
